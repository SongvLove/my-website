...
function getMusicInfo(musicInfo, className, type) {
	...
	musicInfo.forEach( mes => {
		 ele += "<div class='music_list_demon'><div class='music_img'><img width='120' height='120' src='" + mes.img + "' alt='" + mes.name + "'/><div class='music_type'>" + type + "<span class='music_name'>" + mes.name + "</span></div></div><audio controls style='width:260px;'><source src='https://124.220.1.178:8443/music/" + mes.src + "' type='audio/mpeg'><embed height='50' width='100' src='src/music/" + mes.src + "'></audio></div>";
	});
